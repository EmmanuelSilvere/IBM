...
public class ExcelUtilities {
	public static int ij=1;
		...
		private static XSSFRow Row;
		   ...
		   public static int FindNumbeOfRows(String FilePath,String Sheetname) throws Exception{
			   	 FileInputStream ExcelFile = new FileInputStream(FilePath);
			        ExcelWBook = new XSSFWorkbook(ExcelFile);
			        ExcelWSheet = ExcelWBook.getSheet(Sheetname);
			        int RowsInXcel = ExcelWSheet.getPhysicalNumberOfRows();
			        System.out.println("No of Rows :" + RowsInXcel );
			        ExcelFile.close();
			        return RowsInXcel;
			 	}
		
		   public static int FindNumbeOfColumns(String FilePath,String Sheetname) throws Exception{
			   	 FileInputStream ExcelFile = new FileInputStream(FilePath);
			        ExcelWBook = new XSSFWorkbook(ExcelFile);
			        ExcelWSheet = ExcelWBook.getSheet(Sheetname);
			        int ColumnsInXcel = ExcelWSheet.getRow(1).getLastCellNum();
			        System.out.println("No of Columns :" + ColumnsInXcel );
			        ExcelFile.close();
			        return ColumnsInXcel;
			 	}
		


	public static String[][] getTableArray(String FilePath, String SheetName, int Rows, int cols) throws Exception
