...
public class FatherVtChild extends BaseClass{
	...
	public int ARows,ACols,IRows,ICols,GRows,GCols,Arw,Grw,Irw;
	public String AData[][],IData[][],GData[][];
	public String temp,uname,Fname,ssn,ssn1,temp4,f1name,pswd,Lname,Lname1,dob,sex,addrl1,ct,st,zip1,elig,db1,gndr1,rltn,incmtyp1,amt1,freq1,stdate1,enrlmnt;
...
// 			d.findElement(By.xpath("//button[contains(@title,'Close subscription dialog')]")).click();
	...
	@Test
	public void TC1014() throws Exception{
		try {
		...
		groupmembers_app.filliny(f1name,Lname1,db1,gndr1);
		Thread.sleep(3000);
		//common_elements.click(); // Address validation question 
	 ...
	 public String[][] fetchdata(String Sheet, int ApplRows, int ApplCols) throws Exception
	  {
		...
		System.out.println("appl data" + AData[Arw][4]);
		...
		zip1=AData[Arw][15];elig=AData[Arw][45];gndr1=GData[Grw][7];rltn=GData[Grw][58];incmtyp1=IData[Irw][4];amt1=IData[Irw][12];
		freq1=IData[Irw][13];stdate1=IData[Irw][14];enrlmnt=AData[Arw][50];
		
		//dob =AData[Arw][7];Lname=AData[Arw][6];Lname1=GData[Grw][4];db1=GData[Grw][5];
