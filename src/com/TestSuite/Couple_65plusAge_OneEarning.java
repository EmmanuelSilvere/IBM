...
import com.utilities.Constants;
	...
	public class Couple_65plusAge_OneEarning extends BaseClass {
		...
		public String AData[][],IData[][],GData[][],AdjIncTp,AdjInc,AdjStDt,AdjEndDt,AdjFreq;
		...
		public String incmtyp,amt1,freq1,stdate1,newmem,newmem1,enrlmnt,enrlt1,empname,ctzn,Lname1;
		public String Esi2, Esi3, Esi4, Esi5, Esi6, Esi7, Esi8,Esi9, Esi10, Esi11, Esi12, Esi13, Esi14, Esi15;
...
//	 			d.findElement(By.xpath("//button[contains(@title,'Close subscription dialog')]")).click();			
		...
		@Test 
		public void TC1004()throws Exception  { 
			...
			//income_details.Adjustments(AdjIncTp,AdjInc,AdjStDt,AdjEndDt,AdjFreq);
		...
		//	additional_info.EligibleForESI( Esi2, Esi3, Esi4, Esi5, Esi6, Esi7, Esi8, Esi9, Esi10, Esi11, Esi12, Esi13, Esi14, Esi15);
			midWait(3);
			common_elements.click();
			midWait(3);
			add_details.fillin1();
		 ...
		 public void LoadVariables() throws Exception
		  {	 
			...
			incmtyp=IData[Irw][4];amt1=IData[Irw][12];freq1=IData[Irw][13];stdate1=IData[Irw][14];
			newmem=AData[Arw][56];enrlmnt=AData[Arw][50];enrlt1=GData[Grw][44];empname=IData[Irw][6];
			AdjIncTp=IData[Irw][17];AdjInc=IData[Irw][18];AdjStDt=IData[Irw][19];AdjEndDt=IData[Irw][20];AdjFreq=IData[Irw][21];
			
			//folloiwng for Eligible for ESI
			Esi2=IData[Irw][26]; Esi3=IData[Irw][27]; Esi4=IData[Irw][28]; Esi5=IData[Irw][29]; Esi6=IData[Irw][30]; Esi7=IData[Irw][31]; Esi8=IData[Irw][32];
			Esi9=IData[Irw][33]; Esi10=IData[Irw][34]; Esi11=IData[Irw][35]; Esi12=IData[Irw][36]; Esi13=IData[Irw][37]; Esi14=IData[Irw][38];
