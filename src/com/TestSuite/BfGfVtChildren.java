...
public class BfGfVtChildren extends BaseClass{
	...
	String ApplData[][],IncomeData[][],temp,temp1,uname,uname1,Fname,ssn,ssn1,ssn2,ssn3,ssn4,temp4,f1name,f2name,f3name,f4name,Lname1,Lname2,Lname3,Lname4;
	public String AData[][],IData[][],GData[][],empstrt,empct,empst,empzip;
	
	String pswd, Lname, dob, sex, addrl1, ct, st, zip1, elig, enrlmnt, newmem, db1, gndr1, enrlt1, db2;
	String gndr2, enrlt2, db3, gndr3, enrlt3, db4, gndr4, enrlt4, rltn19,rltn20, rltn21, rltn22;
...
// 			d.findElement(By.xpath("//button[contains(@title,'Close subscription dialog')]")).click();
	...
	@Test 
	public void TC1002() throws Exception 
	{
		...
		Thread.sleep(4000);
		relation_ship.fillin5(rltn19,rltn20,rltn21,rltn21);

		relation_ship.fillin6(rltn21,rltn20,rltn21);
	 
		relation_ship.fillin1(rltn20,rltn22);
	
		relation_ship.fillin(rltn22);
	...
	public void LoadVariables() throws Exception
	  {	 
		...
		zip1=AData[Arw][15];elig=AData[Arw][45];newmem=AData[Arw][56];enrlmnt=AData[Arw][50];//dob =AData[Arw][7];Lname=AData[Arw][6];
		
		rltn19=GData[Grw][58];rltn20=GData[Grw+1][58];rltn21=GData[Grw+2][58];rltn22=GData[Grw+3][58];
		//db1=GData[Grw][5];db2=GData[Grw+1][5];db3=GData[Grw+2][5];db4=GData[Grw+3][5];
		gndr1=GData[Grw][7];gndr2=GData[Grw+1][7];gndr3=GData[Grw+2][7];;gndr4=GData[Grw+3][7];
		enrlt1=GData[Grw][44];enrlt2=GData[Grw+1][44];enrlt3=GData[Grw+2][44];enrlt4=GData[Grw+3][44];
		//Lname1=GData[Grw][4];Lname2=GData[Grw+1][4];Lname3=GData[Grw+2][4];Lname4=GData[Grw+3][4];
