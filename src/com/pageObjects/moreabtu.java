...
//	public static By yes_citizen = By.xpath(".//div[@id='__o3id1b_popup2']");
	...
	public static By ReasonForNoSSN = By.id("__o3id1a");
...
//	
   ...
   //public static By no_naturalcitizen = By.xpath(".//div[@id='__o3id1c_popup1']");
	...
	//public static By ssnno = By.id("__o3id18");
       ...
       public static By DocumentType = By.id("__o3id1e");
       
       public static By Nat_LivedInUS = By.id("__o3id1f");
...
//	
	...
	public static By EnrolledInHP = By.id("__o3id24");
